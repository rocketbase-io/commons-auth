...
public interface AppUserService extends UserDetailsService, ValidationUserLookupService {
     ...
     * @param keyValues
     */
    AppUser updateProfile(String username, String firstName, String lastName, String avatar, Map<String, String> keyValues);
     ...
     * @return
     */
    AppUser updateKeyValues(String username, Map<String, String> keyValues);
     ...
     */
    AppUser refreshUsername(String username);
     ...
     * @return initialized user
     */
    AppUser initializeUser(String username, String password, String email, List<String> roles) throws UsernameNotFoundException, EmailValidationException;
     ...
     * @return
     */
    AppUser updateRoles(String username, List<String> roles);
