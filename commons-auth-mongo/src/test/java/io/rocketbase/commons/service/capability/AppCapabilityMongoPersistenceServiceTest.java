...
public class AppCapabilityMongoPersistenceServiceTest extends MongoPersistenceBaseTest {

    @Resource
    private AppCapabilityPersistenceService<AppCapabilityMongoEntity> service;
    ...
    public void findById() {
        ...
        // when
        Optional<AppCapabilityMongoEntity> result = service.findById(CapabilityData.API_BLOG_PUBLISH.getId());
    ...
    public void findAllById() {
        ...
        // when
        List<AppCapabilityMongoEntity> entities = service.findAllById(Arrays.asList(CapabilityData.API_BLOG_PUBLISH.getId(), CapabilityData.API_BLOG_CRUD.getId()));
    ...
    public void findAllByParentId() {
        ...
        // when
        List<AppCapabilityMongoEntity> entities = service.findAllByParentId(Arrays.asList(CapabilityData.API_ROOT.getId(), CapabilityData.USER_READ.getId()));
    ...
    public void findAllByKeyPath() {
        ...
        // when
        Page<AppCapabilityMongoEntity> result = service.findAll(query, PageRequest.of(0, 10, Sort.by("keyPath")));
    ...
    public void save() {
        // given
        AppCapabilityMongoEntity entity = service.initNewInstance();
        ...
        // when
        service.save(entity);
        AppCapabilityMongoEntity result = service.findById(entity.getId()).get();
    ...
    public void deleteTree() {
        ...
        Page<AppCapabilityMongoEntity> page = service.findAll(null, PageRequest.of(0, 10));
