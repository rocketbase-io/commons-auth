...
public class AppTeamMongoPersistenceServiceTest extends MongoPersistenceBaseTest {

    @Resource
    private AppTeamPersistenceService<AppTeamMongoEntity> service;
    ...
    public void findById() {
        ...
        // when
        Optional<AppTeamMongoEntity> result = service.findById(TeamData.TEAM_ONE.getId());
    ...
    public void findAllById() {
        ...
        // when
        List<AppTeamMongoEntity> entities = service.findAllById(Arrays.asList(TeamData.TEAM_ONE.getId(), TeamData.TEAM_THREE.getId()));
    ...
    public void findAll() {
        ...
        // when
        Page<AppTeamMongoEntity> result = service.findAll(query, PageRequest.of(0, 10, Sort.by("name")));
    ...
    public void save() {
        // given
        AppTeamMongoEntity entity = service.initNewInstance();
        ...
        // when
        service.save(entity);
        AppTeamMongoEntity result = service.findById(entity.getId()).get();
    ...
    public void delete() {
        ...
        Optional<AppTeamMongoEntity> result = service.findById(TeamData.TEAM_THREE.getId());
